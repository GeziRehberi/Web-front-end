      ...
      <div className="w-full max-w-md m-auto bg-white rounded-lg border border-primaryBorder shadow-default py-10 px-1">
        <div className="text-primary m-6">
          ...
          <form>
            ...
            <textarea class="w-full h-16 px-3 py-2 text-base text-gray-700 placeholder-gray-600 border rounded-lg outline-none"></textarea>
            ...
            <div class="rounded-lg shadow-xl bg-gray-50">
              <div class="m-4">
                ...
                <div class="flex items-center justify-center w-full">
                  <label class="flex flex-col w-full h-24 border-4 border-dashed hover:bg-gray-100 hover:border-gray-300">
